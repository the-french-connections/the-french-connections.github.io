...
export const all_puzzles: PuzzleImport[] = [
    {
        ...
        puzzle_name: '24 novembre 2025 - Soulèvements de la Terre',
        puzzle_difficulty: 4,
        ...
        groups: [
            {
                ...
                items: ['entreprise', 'oeuvre', 'travail', 'ouvrage'],
                difficulty: 1,
            },
            {
                category: 'Parties d\'une chaise',
                items: ['dossier', 'pieds', 'assise', 'entretoise'],
                difficulty: 2,
            },
            {
                category: 'Instruments de percussion',
                items: ['grelots', 'triangle', 'cloche', 'fouet'],
                difficulty: 3,
            },
            {
                category: 'Jeu de + _',
                items: ['société', 'mots', 'paume', 'boules'],
                difficulty: 4,
            }
        ]
    }, {
        ...
        puzzle_date: new Date('2025-01-01'),
        author: '',
        additional_text: 'Ce puzzle nécéssite une connaissance de l\'alphabet phonétique.',
        groups: [
            {
        ...
        puzzle_date: new Date('2025-01-01'),
        author: '',
        additional_text: 'Selon l\'appareil utilisé, certains emojis peuvent ne pas s\'afficher comme prévu.',
        groups: [
            {
        ...
        groups: [
            ...
            {
                category: 'Aliments et vari�t�s d\'aliments',
        ...
        puzzle_name: '15 avril 2024 - Manche',
        puzzle_difficulty: 5,
        puzzle_date: new Date('2025-01-01'),
        author: '',
        additional_text: '',
        groups: [
            {
                ...
                items: ['Pinceau', 'Miroir', 'Baume', 'Ombreur'],
                difficulty: 1,
            },
            {
                category: 'Grandit',
                items: ['Pousse', 'Progresse', '\u00E9l\u00E8ve', 'Cro\u00EEt'],
                difficulty: 2,
            },
            {
                category: 'Diff\u00E9rents sens de \u00AB ma\u00EEtre \u00BB',
                items: ['Enseignant', 'Chef', 'Propri\u00E9taire', 'Artiste'],
                difficulty: 3,
            },
            {
                category: '_ + anglaise',
                items: ['Cl\u00E9', 'Cr\u00E8me', 'Cour', 'Semaine'],
                difficulty: 4,
            },
        ]
    }, {
