...
export const App = () => {
    ...
    const isNextPuzzle = currentMonth > 7 || (currentMonth === 7 && currentDay >= 8); //TOCHANGE


    const current_puzzle = isNextPuzzle ? gr_08_07_2024 : gr_05_07_2024; //TOCHANGE
    const ending_text = isNextPuzzle ? "The French Connections #31. Prochain puzzle le 12 juillet." : "The French Connections #30. Prochain puzzle le 8 juillet."; //TOCHANGE
