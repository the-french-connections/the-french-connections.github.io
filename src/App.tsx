...
export const App = () => {
    ...
    const isNextPuzzle = currentMonth > 2 || (currentMonth === 2 && currentDay >= 17); //TOCHANGE


    const current_puzzle = isNextPuzzle ? gr_17_02_2025 : gr_10_02_2025; //TOCHANGE
    const ending_text = isNextPuzzle ? "The French Connections #57. Prochain puzzle le 24 f\u00E9vrier." : "The French Connections #56. Prochain puzzle le 17 f\u00E9vrier."; //TOCHANGE
