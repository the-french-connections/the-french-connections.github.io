...
export const App = () => {
    ...
    const isNextPuzzle = currentMonth > 6 || (currentMonth === 6 && currentDay >= 9); //TOCHANGE


    const current_puzzle = isNextPuzzle ? gr_09_06_2025 : gr_02_06_2025; //TOCHANGE
    const ending_text = isNextPuzzle ? "The French Connections #71. Prochain puzzle lundi prochain." : "The French Connections #70. Prochain puzzle lundi prochain."; //TOCHANGE
