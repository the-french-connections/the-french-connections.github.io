...
export const App = () => {
    ...
    const isNextPuzzle = currentMonth > 6 || (currentMonth === 6 && currentDay >= 24); //TOCHANGE


    const current_puzzle = isNextPuzzle ? gr_24_06_2024 : gr_21_06_2024; //TOCHANGE
    const ending_text = isNextPuzzle ? "The French Connections #27. Prochain puzzle le 28 juin." : "The French Connections #26. Prochain puzzle le 24 juin."; //TOCHANGE
