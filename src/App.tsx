...
export const App = () => {
    ...
    const isNextPuzzle = currentMonth > 6 || (currentMonth === 6 && currentDay >= 16); //TOCHANGE


    const current_puzzle = isNextPuzzle ? gr_16_06_2025 : gr_09_06_2025; //TOCHANGE
    const ending_text = isNextPuzzle ? "The French Connections #72. Prochain puzzle lundi prochain." : "The French Connections #71. Prochain puzzle lundi prochain."; //TOCHANGE
