...
export const App = () => {
    ...
    const isNextPuzzle = currentMonth > 2 || (currentMonth === 2 && currentDay >= 24); //TOCHANGE


    const current_puzzle = isNextPuzzle ? gr_24_02_2025 : gr_17_02_2025; //TOCHANGE
    const ending_text = isNextPuzzle ? "The French Connections #58. Prochain puzzle le 3 mars." : "The French Connections #57. Prochain puzzle le 24 f\u00E9vrier."; //TOCHANGE
