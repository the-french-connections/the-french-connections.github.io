...
export const App = () => {
    ...
    const isNextPuzzle = currentMonth > 6 || (currentMonth === 6 && currentDay >= 30); //TOCHANGE


    const current_puzzle = isNextPuzzle ? gr_30_06_2025 : gr_23_06_2025; //TOCHANGE
    const ending_text = isNextPuzzle ? "The French Connections #74. Prochain puzzle lundi prochain." : "The French Connections #73. Prochain puzzle lundi prochain."; //TOCHANGE
