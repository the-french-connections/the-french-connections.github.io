...
export const App = () => {
    ...
    const isNextPuzzle = currentMonth > 3 || (currentMonth === 3 && currentDay >= 24); //TOCHANGE


    const current_puzzle = isNextPuzzle ? gr_24_03_2025: gr_10_03_2025; //TOCHANGE
    const ending_text = isNextPuzzle ? "The French Connections #60. Prochain puzzle à une date indéterminée." : "The French Connections #59. Prochain puzzle le 24 mars."; //TOCHANGE
