...
export const App = () => {
    ...
    const ending_text = isNextPuzzle ? "The French Connections #68. Prochain puzzle lundi prochain." : "The French Connections #67. Prochain puzzle lundi prochain."; //TOCHANGE
