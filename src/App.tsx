...
export const App = () => {
    ...
    const current_puzzle = isNextPuzzle ? gr_12_05_2025 : gr_05_05_2025; //TOCHANGE
    const ending_text = isNextPuzzle ? "The French Connections #66. Prochain puzzle lundi prochain." : "The French Connections #65. Prochain puzzle lundi prochain."; //TOCHANGE
