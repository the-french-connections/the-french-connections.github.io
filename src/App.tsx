...
export const App = () => {
    ...
    const isNextPuzzle = currentMonth > 1 || (currentMonth === 1 && currentDay >= 6); //TOCHANGE


    const current_puzzle = isNextPuzzle ? gr_06_01_2025 : gr_25_12_2024; //TOCHANGE
    const ending_text = isNextPuzzle ? "The French Connections #51. Prochain puzzle le 13 janvier." : "The French Connections #50. Prochain puzzle le 6 janvier."; //TOCHANGE
