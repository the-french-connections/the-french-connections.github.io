...
export const App = () => {
    ...
    const isNextPuzzle = currentMonth > 7 || (currentMonth === 7 && currentDay >= 14); //TOCHANGE


    const current_puzzle = isNextPuzzle ? gr_14_07_2025 : gr_30_06_2025; //TOCHANGE
    const ending_text = isNextPuzzle ? "The French Connections #75. Prochain puzzle lundi prochain." : "The French Connections #74. Prochain puzzle lundi prochain."; //TOCHANGE
