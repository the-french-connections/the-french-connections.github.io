...
export const App = () => {
    ...
    const isNextPuzzle = currentMonth > 6 || (currentMonth === 6 && currentDay >= 2); //TOCHANGE


    const current_puzzle = isNextPuzzle ? gr_02_06_2025 : gr_26_05_2025; //TOCHANGE
    const ending_text = isNextPuzzle ? "The French Connections #70. Prochain puzzle lundi prochain." : "The French Connections #69. Prochain puzzle lundi prochain."; //TOCHANGE
                    ...
                    <Modal isOpen={isOpenRules} onClose={handleCloseRules}>
                        ...
                        <ModalContent>
                            ...
                            <ModalBody>
                                ...
                                <Text mb='1rem'>S&agrave; l'exception du puzzle en cours, les autres grilles sont not&eacute;es (par moi) en difficult&eacute; de 1 &agrave; 5 &eacute;toiles.</Text>
