...
export const App = () => {
    ...
    const isNextPuzzle = currentMonth > 2 || (currentMonth === 2 && currentDay >= 3); //TOCHANGE


    const current_puzzle = isNextPuzzle ? gr_03_02_2025 : gr_27_01_2025; //TOCHANGE
    const ending_text = isNextPuzzle ? "The French Connections #55. Prochain puzzle le 10 f\u00E9vrier." : "The French Connections #54. Prochain puzzle le 2 f\u00E9vrier."; //TOCHANGE
