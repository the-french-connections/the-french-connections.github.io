...
export const App = () => {
    ...
    const isNextPuzzle = currentMonth > 4 || (currentMonth === 4 && currentDay >= 14); //TOCHANGE


    const current_puzzle = isNextPuzzle ? gr_14_04_2025 : gr_07_04_2025; //TOCHANGE
    const ending_text = isNextPuzzle ? "The French Connections #63. Prochain puzzle \u00E0 une date ind\u00E9termin\u00E9e." : "The French Connections #62. Prochain puzzle \u00E0 une date ind\u00E9termin\u00E9e."; //TOCHANGE
