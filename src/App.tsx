...
export const App = () => {
    ...
    const isNextPuzzle = currentMonth > 6 || (currentMonth === 6 && currentDay >= 21); //TOCHANGE


    const current_puzzle = isNextPuzzle ? gr_21_06_2024 : gr_19_06_2024; //TOCHANGE
    const ending_text = isNextPuzzle ? "The French Connections #26. Prochain puzzle le 24 juin." : "The French Connections #25. Prochain puzzle le 21 juin."; //TOCHANGE
