...
export const App = () => {
    ...
    const isNextPuzzle = currentMonth > 7 || (currentMonth === 7 && currentDay >= 21); //TOCHANGE


    const current_puzzle = isNextPuzzle ? gr_21_07_2025 : gr_14_07_2025; //TOCHANGE
    const ending_text = isNextPuzzle ? "The French Connections #76. Prochain puzzle lundi prochain." : "The French Connections #75. Prochain puzzle lundi prochain."; //TOCHANGE
