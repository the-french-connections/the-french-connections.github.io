...
export const App = () => {
    ...
    const isNextPuzzle = currentMonth > 1 || (currentMonth === 1 && currentDay >= 27); //TOCHANGE


    const current_puzzle = isNextPuzzle ? gr_27_01_2025 : gr_20_01_2025; //TOCHANGE
    const ending_text = isNextPuzzle ? "The French Connections #54. Prochain puzzle le 3 f\u00E9vrier." : "The French Connections #53. Prochain puzzle le 27 janvier."; //TOCHANGE
