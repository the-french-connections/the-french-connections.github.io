...
export const App = () => {
    ...
    const isNextPuzzle = currentMonth > 7 || (currentMonth === 7 && currentDay >= 15); //TOCHANGE


    const current_puzzle = isNextPuzzle ? gr_15_07_2024 : gr_12_07_2024; //TOCHANGE
    const ending_text = isNextPuzzle ? "The French Connections #33. Prochain puzzle le 19 juillet." : "The French Connections #32. Prochain puzzle le 15 juillet."; //TOCHANGE
